...
"""
"""
importing this block for encryption purpose
"""
import base64
import hashlib
...
"""
Importing this block for steganography purpose
"""
import logging
import os
import sys
...
def hide_message_in_image(input_image, message, num_lsb):
    ...
    image.putdata(list(zip(*[iter(flattened_color_data)] * num_channels))) # Custom comment this function change the LSB in RGB
